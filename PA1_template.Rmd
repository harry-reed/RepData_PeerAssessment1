...
MEAN and MEDIAN of Total Number of Steps Taken Each Day (ignoring NAs):  mean = `r dayStepSumMean_NoNA` and median = `r dayStepSumMedian_NoNA`.
...
The 5-minute interval `r ans$interval` with value `r ans$avg` contained the maximum number of steps taken (dataset ignoring NAs).
...
MEAN and MEDIAN of Total Number of Steps Taken Each Day (with imputed NAs):  mean = `r dayStepSumMean_Imputed` and median = `r dayStepSumMedian_Imputed`.
